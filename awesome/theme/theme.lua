...
-- Vintage
theme.vcolor0     = "#F7FBFC"
theme.vcolor1     = "#F5F1DA"
theme.vcolor2     = "#F68989"
theme.vcolor3     = "#769FCD"
...
theme.enter_event = "#ffffff" 
theme.press_event = transparent 
theme.release_event = transparent 
...
-- Wallpaper
theme.wallpaper = gfs.get_configuration_dir() .. "theme/assets/wallpapers/falafel.png"
...
-- Mainmenu
theme.menu_font = theme.font_name 
...
theme.tooltip_font = theme.font_name 

-- Hotkeys Pop Up
theme.hotkeys_bg = theme.xbackground
theme.hotkeys_fg = theme.xforeground
theme.hotkeys_modifiers_fg = theme.xforeground
theme.hotkeys_font = theme.font_name
theme.hotkeys_description_font = theme.font_name
...
theme.dock_focused_bg = theme.transparent
theme.dock_accent = theme.transparent
