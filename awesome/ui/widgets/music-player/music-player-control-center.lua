...
-- Play pause button
local music_play_pause = create_media_button(beautiful.icon_font .. " Round 12", "", function()
	playerctl:play_pause()
end)

-- Previous button
local music_previous = create_media_button(beautiful.icon_font .. " Round 12", "", function()
	playerctl:previous()
end)

-- Next button
local music_next = create_media_button(beautiful.icon_font .. " Round 12", "", function()
	playerctl:next()
end)
